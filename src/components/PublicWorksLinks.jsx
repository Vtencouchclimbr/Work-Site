import './PublicWorksLinks.css';

const PublicWorksLinks = () => {
  return (
<div className="public-works-links">
      <h1>All Utah County Public Works Resources</h1>

      <h2 className='pwtitles'>Beaver County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Box Elder County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Cache County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Carbon County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Daggett County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Davis County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Duchesne County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Emery County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Garfield County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Juab County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Kane County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Millard County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Morgan County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Piute County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Rich County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Salt Lake County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>San Juan County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Sanpete County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Sevier County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Summit County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Tooele County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Uintah County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Utah County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Wasatch County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Washington County</h2>
      <ul>
...
{/*  */}
      <h2 className='pwtitles'>Wayne County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Weber County</h2>
      <ul>
      ...
      <h2 className='pwtitles'>Additional Resources</h2>
      <ul>
        <li><a href="https://www.rideuta.com" target="_blank" rel="noopener noreferrer">Utah Transit Authority (UTA)</a></li>
        <li><a href="https://frontrunner2x.utah.gov" target="_blank" rel="noopener noreferrer">FrontRunner 2X Project</a></li>
        <li><a href="https://www.udot.utah.gov" target="_blank" rel="noopener noreferrer">Utah Department of Transportation (UDOT)</a></li>
        <li><a href="https://www.bluestakes.org" target="_blank" rel="noopener noreferrer">Blue Stakes of Utah (811)</a></li>
      </ul>
    </div>
  );
};

export default PublicWorksLinks;